...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private Object CookieClearingLogoutHandler;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers(HttpMethod.POST,"/api/logout").hasAnyAuthority("ROLE_USER");
        http.authorizeRequests().anyRequest().permitAll();
        http.addFilter(new CustomAuthenticationFilter(jwtUtils, authenticationManagerBean()));
